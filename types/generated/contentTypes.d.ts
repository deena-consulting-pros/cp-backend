...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    approachHeading: Schema.Attribute.Component<
      'shared.section-heading',
      false
    >;
    approachSteps: Schema.Attribute.Component<'home.process-step', true>;
    competencies: Schema.Attribute.Component<'home.chip', true>;
    competenciesTitle: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    edgeHeading: Schema.Attribute.Component<'shared.section-heading', false>;
    edgeImage: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    edgeItems: Schema.Attribute.Component<'home.feature-card', true>;
    experts: Schema.Attribute.Component<'about.expert-card', true>;
    expertsHeading: Schema.Attribute.Component<'shared.section-heading', false>;
    finalCta: Schema.Attribute.Component<'shared.cta-block', false>;
    hero: Schema.Attribute.Component<'shared.hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    missionVisionCards: Schema.Attribute.Component<'shared.info-card', true>;
    pillars: Schema.Attribute.Component<'about.pillar-card', true>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    values: Schema.Attribute.Component<'home.feature-card', true>;
    valuesHeading: Schema.Attribute.Component<'shared.section-heading', false>;
  };
}
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contactFormSection: Schema.Attribute.Component<
      ...
      false
    >;
    contactInfoCards: Schema.Attribute.Component<'shared.info-card', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    finalCta: Schema.Attribute.Component<'shared.cta-block', false>;
    hero: Schema.Attribute.Component<'shared.hero', false>;
    heroPoints: Schema.Attribute.Component<'shared.icon-text-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    nextSteps: Schema.Attribute.Component<'shared.step-card', true>;
    nextStepsHeading: Schema.Attribute.Component<
      'shared.section-heading',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    addressCountryCode: Schema.Attribute.String;
    businessAddress: Schema.Attribute.Component<'shared.address', false>;
    ...
    siteLanguage: Schema.Attribute.String;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    finalCta: Schema.Attribute.Component<'shared.cta-block', false>;
    hero: Schema.Attribute.Component<'shared.hero', false>;
    introChips: Schema.Attribute.Component<'home.chip', true>;
    introHeading: Schema.Attribute.Component<'shared.section-heading', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    portfolioButton: Schema.Attribute.Component<'shared.link', false>;
    portfolioHeading: Schema.Attribute.Component<
      'shared.section-heading',
      false
    >;
    ...
    >;
    processHeading: Schema.Attribute.Component<'shared.section-heading', false>;
    processSteps: Schema.Attribute.Component<'home.process-step', true>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    servicesHeading: Schema.Attribute.Component<
      'shared.section-heading',
      false
    >;
    ...
    testimonialsHeading: Schema.Attribute.Component<
      ...
      false
    >;
    trustedHeading: Schema.Attribute.Component<'shared.section-heading', false>;
    trustedLogos: Schema.Attribute.Relation<
      'oneToMany',
      'api::client-logo.client-logo'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whyChooseBackgroundImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    whyChooseCards: Schema.Attribute.Component<'home.feature-card', true>;
    whyChooseHeading: Schema.Attribute.Component<
      'shared.section-heading',
      false
    >;
    whyChooseImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
  };
}
...
export interface ApiLegalPageLegalPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    legal_pages: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cardActionButtonText: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    >;
    shortDescription: Schema.Attribute.Text;
    showcaseButton: Schema.Attribute.Component<'shared.link', false>;
    showcaseDescription: Schema.Attribute.Text;
    showcaseEyebrow: Schema.Attribute.String;
    showcaseFeatures: Schema.Attribute.Component<'shared.features-text', true>;
...
export interface ApiServicesPageServicesPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    benefits: Schema.Attribute.Component<'shared.info-card', true>;
    benefitsSectionHeading: Schema.Attribute.Component<
      'shared.section-heading',
      false
    >;
    connectedSolutions: Schema.Attribute.Component<
      'services.connected-solutions',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    > &
      Schema.Attribute.Private;
    partnershipStages: Schema.Attribute.Component<
      'services.partnership-stage',
      true
    >;
    partnershipStagesHeading: Schema.Attribute.Component<
      'shared.section-heading',
      false
    >;
    processHeading: Schema.Attribute.Component<'shared.section-heading', false>;
    processSection: Schema.Attribute.Component<'home.process-step', true>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
